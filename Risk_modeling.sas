...
/*Anova test: To check if people with different annual income have equal fico score?*/
proc glm data = risk_data;
	class income_category;
	model fico_avg = income_category;
run;

/*Report of univariate procedure includes Moments, Tests for location and normality(parametric/non-parametric Tests), Quantiles, missing values*/
